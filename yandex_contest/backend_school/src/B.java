...
public class B {
    ...
    public static void solution() {
        ...
        for (String c: competitions.keySet()){
            res.addAll(map.get(c).stream().sorted(Comparator.comparingInt(Competitor::getPerformance).reversed().thenComparingInt(Competitor::getPenalty)).limit(competitions.get(c)).collect(Collectors.toList()));
        }
